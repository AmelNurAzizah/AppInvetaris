     ...
     <div class="row mb-2">
       ...
       <div class="col-sm-6">
         <ol class="breadcrumb float-sm-right">
           <li class="breadcrumb-item"><a href="/inventaris">{{ $judul }}</a></li>
     ...
     <div class="row">
       <div class="col-lg-12">
        <div class="card">
            ...
            <form action="updateI" method="POST" class="form-horizontal">
              @csrf
              <input type="hidden" name="id" value="{{ $d->id_inventaris }}">
              <div class="card-body">
                <div class="mb-3 row">
